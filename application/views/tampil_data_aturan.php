	    ...
	    <div class="table">
			<div class="col-lg-10 mx-auto">
			    <h1 class="text-uppercase">   
					<strong>Data Aturan</strong></h1><hr>
			    ...
			    <a class="btn btn-primary" href="<?php echo base_url();?>index.php/Admin_controller/tambahView"><span>Tambah Aturan</span></a>
			        <div class="row header">
			           <table>
							...
							<tbody>
								<?php 
									foreach ( $aturan->result_array() as $key) {
										?>
										<tr>
											...
											<td>
												<a href="<?php echo base_url('Admin_controller/delete_ps/'.$key['id_pasien'])?>">Hapus</a> 
