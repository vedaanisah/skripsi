...
<h3>Data Penyakit</h3>
<br>
    <form class="body" method="post" action="<?php echo base_url().'Main_controller/update_pk/'.$penyakit->id_penyakit;?>">
        <div class="form-group">
            <label>Id Penyakit</label>
            <input type="text" name="id_penyakit" class="form-control" value="<?php echo $penyakit->id_penyakit?>" disabled>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="penjelasan" class="form-control" value="<?php echo $penyakit->penjelasan?>">
        </div>
